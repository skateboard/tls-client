 ...
 * @author mkstayalive
 *
 * I didn't want to use a library for this, so I just imported it.
 **/
public class RandomUserAgent {
    private static final Map<String, String[]> browserUserAgents = new HashMap<>();
    private static final Random random = new Random();

    static {
        browserUserAgents.put("Internet Explorer", new String[] {
        ...
        browserUserAgents.put("Firefox", new String[] {
        ...
        browserUserAgents.put("Chrome", new String[] {
        ...
        browserUserAgents.put("Safari", new String[] {
        ...
        browserUserAgents.put("Opera", new String[] {
    ...
    public static String getRandomUserAgent(String browser) {
        final String[] userAgentsForBrowser = browserUserAgents.get(browser);

        return userAgentsForBrowser[random.nextInt(userAgentsForBrowser.length)];
    }
}
